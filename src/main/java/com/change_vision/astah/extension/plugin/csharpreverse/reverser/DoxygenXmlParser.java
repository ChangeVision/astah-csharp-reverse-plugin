...
public class DoxygenXmlParser {
    ...
    public static String parser(String path, CloseDialog closeDialog) throws LicenseNotFoundException,
        ...
        InputStream stream = DoxygenXmlParser.class.getResourceAsStream("C_Sharp.asta");
