package com.change_vision.astah.extension.plugin.csharpreverse;
...
public class Messages implements IMessageProvider{
	 ...
	 */
	public static final String DEFAULT_BUNDLE = "com.change_vision.astah.extension.plugin.csharpreverse.messages";
